    ...
    <div className="container-narrow py-8 lg:py-12">
      <header className="mb-12 lg:mb-16">
        ...
        <p className="mt-4 max-w-[60ch] text-base text-[color:var(--color-ink-2)]">
          ...
          and soft-matter chemical physics.
        </p>
      </header>
        ...
        {research.map((thrust, i) => {
          ...
          return (
            <Reveal
              ...
              id={thrust.slug}
              delay={i * 80}
              className="thrust-card scroll-mt-20 border-t border-[color:var(--color-rule)] pt-10 first:border-t-0 first:pt-0"
            >
              <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:gap-10">
                ...
                <div className="min-w-0 flex-1">
                  <p className="mb-3 font-mono text-xs tracking-[0.08em] text-[color:var(--color-accent)]">
                    R-{String(i + 1).padStart(2, "0")}
                  </p>
                  <h2 className="h2 max-w-[34ch]">
                    <span className="thrust-title-underline">
                      {thrust.title}
                    </span>
                  </h2>
                  <div className="prose-body mt-4 max-w-[62ch] space-y-4">
                  ...
                  {keyPubs.length > 0 ? (
                    <div className="mt-6">
                      <p className="mb-2 font-mono text-xs uppercase tracking-[0.12em] text-[color:var(--color-ink-3)]">
                        Key publications
                      </p>
